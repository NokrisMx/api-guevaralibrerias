...
public class DashboardController : ControllerBase
{
    ...
    {
        var ordersByStatus = await _repo.GetOrdersByStatus();
    ...
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(StatusCodes.Status403Forbidden)]
    public async Task<IActionResult> GetRevenueByMonth([FromQuery] int months = 6)
    {
        var revenueByMonth = await _repo.GetRevenueByMonth(months);
